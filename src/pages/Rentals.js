...
const Rentals = () => {
  ...
  // constant handles booking status 
  const handleSuccess= () => {
    dispatch({
      type: "success",
      message: `Congratulations! You are going to ${searchFilters.destination}!!`,
...
// This effect fetches the rentals from moralis database
  useEffect(() => {
  ...
  const bookRental = async function (start, end, id, dayPrice) {
    ...
    let options = {
      contractAddress: "0x3D55dA772c32574fD032c812d9c05E1C8C321Cde",
