...
contract airbnb {
    ...
    // This is where the user can add a rental home to airBnb
    function addRentals(
        string memory name,
        string memory city,
        string memory lat,
        ...
        require(msg.sender == owner, "Only owner of the smart contract can post rentals");
    ...
    // This is where we check new bookings
